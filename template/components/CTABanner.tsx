...
export function CTABanner() {
  return (
    <section id="apply" className="py-24 relative overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-96 h-96 rounded-full opacity-10 blur-3xl" style={{ background: "#F5C800" }} />
      <div className="absolute bottom-0 left-0 w-72 h-72 rounded-full opacity-10 blur-3xl" style={{ background: "#F5C800" }} />
      {/* Dots pattern */}
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl">
            ...
            <div className="space-y-4">
              {[
                { label: "Prénom & Nom", placeholder: "ex. Sofia Benali", type: "text" },
                { label: "Adresse e-mail", placeholder: "sofia@email.com", type: "email" },
